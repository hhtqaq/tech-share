...
import com.shopee.study.ratelimiter.v2.rule.parser.JsonRuleConfigParser;
import com.shopee.study.ratelimiter.v2.rule.parser.RuleConfigParser;
import com.shopee.study.ratelimiter.v2.rule.parser.YamlRuleConfigParser;
 ...
 * @className: com.shopee.study.ratelimiter.v2.rule.datasource.FileRuleConfigSource
    ...
    public RuleConfig load() {
        for (String extension : SUPPORT_EXTENSIONS) {
            try(InputStream in= this.getClass().getResourceAsStream("/" + getFileNameByExt(extension))){
                ...
                log.error("Error parsing rule configuration file: " + getFileNameByExt(extension), ignored);
            }
